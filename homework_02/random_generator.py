...
def generate_json(num_sites):
    ...
    for i in range(num_sites):
        site_dictionary_list.append({"site_id" : i+1, "latitude" : generate_random_lat(), "longitude" : generate_random_long(), "composition" : generate_random_composition(compositions)})
