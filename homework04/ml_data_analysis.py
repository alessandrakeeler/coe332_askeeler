...
def main():
    ...
    print("the average mass among the meteors is: ")
    ...
    for row in ml_data['meteorite_landings']:
        if check_hemisphere(float(row['reclat']), float(row['reclong'])) == "Northern & Western":
            nw += 1
        elif check_hemisphere(float(row['reclat']), float(row['reclong'])) == "Northern & Eastern":
            ne += 1
    ...
    print(
        f"There were {ne} meteors found in the NE hemisphere, {nw} meteors found in the NW hemisphere, {se} meteors found in the SE hemisphere, and {se} meteors found in the SW hemisphere. ")
